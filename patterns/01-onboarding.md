...
**Status:** 🚧 Draft - Citations being added
...
**Current State:**
- Nostr clients require 15-20 minutes of setup before users can post [User: To be cited]
...
**Why This Matters:**
Onboarding is not just about getting users in - it's about getting them to their first moment of value fast enough that they want to stay. Research shows users will abandon apps that take more than 2 minutes to demonstrate value [Research: Nielsen Norman Group - to be specifically cited]. Current Nostr onboarding takes 10x that long.
...
**Research backing:** [Research: Time-to-first-value studies - to be cited]

**Examples from mainstream apps:**
- **TikTok:** Opens directly to For You feed, no signup required. Value (entertaining videos) is immediate [Example: TikTok onboarding teardown - to be cited]
...
**Research backing:** [Research: Progressive disclosure in HCI - to be cited]
...
**Research backing:** [Research: Friction laddering in product design - to be cited]
...
**Research backing:** [Research: Social proof in conversion optimization - to be cited]
...
**Research backing:** [Research: Gamification and early wins - to be cited]
...
**Research backing:** [Research: Just-in-time learning in UX - to be cited]
...
**Current failures:**
- Showing nsec on signup with "NEVER SHARE THIS, DON'T LOSE IT"
...
- [ ] **D1 retention:** % of users who return day 1 after signup
  - Target: >40% (benchmark: [Data: Social app averages - to be cited])

- [ ] **D7 retention:** % of users who return day 7
  - Target: >20%

- [ ] **D30 retention:** % of users who return day 30
  - Target: >10% (current Nostr: trending to 0% [Data:1])
...
**Source:** [Example: TikTok product teardown - to be cited]
...
**Source:** [Example: Discord onboarding - to be cited]
...
**Source:** [Example: Instagram onboarding analysis - to be cited]
...
[Research: To be added] Nielsen Norman Group - Time to First Value studies
[Research: To be added] Progressive disclosure in UI design
[Research: To be added] Friction laddering in conversion optimization
[Research: To be added] Social proof in digital products

### Examples & Case Studies
[Example: To be added] TikTok onboarding teardown and analysis
[Example: To be added] Discord onboarding flow
[Example: To be added] Instagram interest-based onboarding
...
### User Feedback
[User: To be added] "15-20 minute setup" observations
[User: To be added] Key management anxiety quotes
[User: To be added] Empty feed complaints
...
*Status: Draft with citation placeholders*
